...
/*    @Override
    ...
    public void update(String author, BoardForm updateParam) {
        String sql = "update board set title = :title, contents = :contents, board_type_code = :boardTypeCode where author = :author";
        MapSqlParameterSource param = new MapSqlParameterSource()
                .addValue("title", updateParam.getTitle())
                .addValue("contents", updateParam.getContents())
                .addValue("boardTypeCode", updateParam.getBoardTypeCode())
